...
app.use(helmet.contentSecurityPolicy({
  directives: {
    defaultSrc: ["'self'"],
    scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://vercel.live", "https://kit.fontawesome.com", "https://*.vercel.app"],
    styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com", "https://cdnjs.cloudflare.com"],
    imgSrc: ["'self'", "data:", "blob:", "https://*.vercel.app"],
    fontSrc: ["'self'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com", "data:"],
    connectSrc: ["'self'", "https://vercel.live", "https://*.vercel.app", "wss://*.vercel.app"],
    frameSrc: ["'self'"],
    mediaSrc: ["'self'", "data:"],
    workerSrc: ["'self'", "blob:"],
    manifestSrc: ["'self'"],
