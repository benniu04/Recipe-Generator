<script>
    ...
    async function handlePasswordReset(event) {
        ...
        try {
            ...
            successMessage = 'Password email sent successfully';
            ...
            <div class="w-[420px] bg-transparent rounded-xl px-[30px] py-[50px]">
                <form>
                    ...
                    <div class="w-[100%] h-[50px] my-[30px] mx-0">
                        <input bind:value={email} class="input-box" placeholder="Your email" required>
                    </div>
                    <button on:click= {handlePasswordReset} type="submit" class="w-full h-[45px] bg-white border-0 rounded-[40px] shadow cursor-pointer text-base text-gray-800 font-semibold focus:outline-none">Request reset link</button>
